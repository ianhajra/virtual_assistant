...
def test_stem():
    ...
    assert stem("relationally") == "relational"
    assert stem("relationalize") == "relational"
    ...
    assert stem("running") == "run"
    assert stem("runner") == "runner"
    assert stem("runners") == "runner"
    assert stem("quickly") == "quick"
    assert stem("quicker") == "quicker"
    assert stem("quickest") == "quickest"
    assert stem("national") == "nation"
    assert stem("nationalize") == "nation"
    assert stem("nationalized") == "nation"
    assert stem("organization") == "organ"
    assert stem("organizational") == "organ"
    assert stem("organizationally") == "organ"
    assert stem("popping") == "pop"
    assert stem("pops") == "pop"
    assert stem("popped") == "pop"
    assert stem("leaves") == "leav"
    assert stem("leaving") == "leav"
    assert stem("leaf") == "leaf"